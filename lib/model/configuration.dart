import 'package:pcrypt/model/manual.dart';
...
class RemoteConfiguration {
  ...
  static RemoteConfiguration fromJson(Map<String, dynamic> data) {
    return RemoteConfiguration(
      ...
      disableCreateConfirmationEmail: data['disablecreateconfirmationemail'] ?? true,
      ...
      haveIBeenPwnedApiKey: _parseSpecialString(data['haveibeenpwnedapikey']) ?? '',
      ...
      ldapLoginCompleteEmail: _parseSpecialString(data['LDAP_logincompleteemail']) ?? '',
      ...
      manualUrl: data['manualurl'] != null ? ManualList.fromJson(data['manualurl']) : null,
      manualAppUrl: data['manualappurl'] != null ? ManualList.fromJson(data['manualappurl']) : null,
      manualMailUrl: data['manualmailurl'] != null ? ManualList.fromJson(data['manualmailurl']) : null,
    );
  }
