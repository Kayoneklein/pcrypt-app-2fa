...
class TeamMember {
  ...
  Map<String, dynamic> toJson() => <String, dynamic>{
        ...
        'teamkeysfromid':
            _teamKeysFromId > -1 ? teamKeysFromId.toString() : null,
  ...
  static TeamMember fromJson(Map<String, dynamic> data) => TeamMember(
        ...
        teamKeysFromId:
            data['teamkeysfromid'] != null ? data['teamkeysfromid'] : -1,
...
class TeamBinary {
  ...
  static TeamBinary fromJson(
          String id, int userId, Map<String, dynamic> data) =>
      TeamBinary(
        id: id,
        userId: userId,
        name: data['name'] ?? '',
