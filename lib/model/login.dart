...
class LoginKeys {
  ...
  static LoginKeys fromJson(Map<String, dynamic> data) => LoginKeys(data['aes'], data['srp']);
}
...
class LoginCredentials {
  ...
  static LoginCredentials fromJson(Map<String, dynamic> data) => LoginCredentials(data['A'], data['M1']);
}

/// Data used for sign up process
class AccountData {
  AccountData(this.email, this.srpSalt, this.srpVerifier, this.salt, this.publicKey, this.privateKey);
