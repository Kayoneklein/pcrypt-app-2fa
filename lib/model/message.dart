...
class MessageEncrypted {
  ...
  static MessageEncrypted fromJson(Map<String, dynamic> data) => MessageEncrypted(
        mailId: data['mailid'],
...
class MessageToSend {
  ...
  Map<String, dynamic> toJson() => <String, dynamic>{
    ...
    'note': message,
    'teamid': teamId,
    'shares': shares.map<String, dynamic>((k, v) => MapEntry<String, dynamic>(k.toString(), v)),
  ...
  try {
    if (data != null && data is Map<String, dynamic>) {
      return Map<int, List<int>>.fromIterable(
        data.entries.where((e) => int.tryParse(e.key) != null && e.value is List),
