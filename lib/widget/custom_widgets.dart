...
import 'package:pcrypt/home/presentation/screens/upgrade_screen.dart';
...
class GreyBorderContainer extends Container {
  GreyBorderContainer({Widget? child})
      : super(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            actions: [
              TextButton(
                child:
                    Text(Strings. /*!!!actionCancel*/ actionOk.toUpperCase()),
                onPressed: () {
                  Navigator.of(context).pop(false);
                },
              ),
//!!!              TextButton(
//                child: Text(Strings.actionUpgrade.toUpperCase()),
//                onPressed: () {
