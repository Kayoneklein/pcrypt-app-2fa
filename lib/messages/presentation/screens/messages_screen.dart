...
import 'package:pcrypt/messages/presentation/widgets/messages_list.dart';
...
class MessagesScreen extends StatelessWidget {
        ...
        if (state is MessageSentState) {
          ...
          ScaffoldMessenger.of(context)
            ...
            ..showSnackBar(
              state.isSuccess
                  ? SnackBar(
                      content: Text(Strings.messagesSendSuccess),
                    )
                  : SnackBar(
  ...
  Future<void> _viewMessageDetails(
      BuildContext context, Message message, MessagesBox box) async {
