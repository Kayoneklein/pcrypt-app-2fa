...
class MessagesState extends Equatable {
  ...
  int get newMessagesCount  => (inboxMessages + outboxMessages).where((m) => !m.isRead).length;
...
class MessageSentState extends MessagesState {
  MessageSentState.from(MessagesState state, {required this.isSuccess, this.message})
      : super(
