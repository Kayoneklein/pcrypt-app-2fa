...
import 'package:pcrypt/tags/bloc/tags.dart';
import 'package:pcrypt/tags/presentation/widgets/tags_list.dart';
  ...
  void _tagsUpdateResult(BuildContext context, bool isSuccess) {
    if (isSuccess) {
      ScaffoldMessenger.of(context)
        ..hideCurrentSnackBar()
        ..showSnackBar(
          SnackBar(content: Text(Strings.tagsUpdateSuccess)),
        );
    } else {
      showDialog<void>(
        context: context,
