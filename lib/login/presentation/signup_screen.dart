...
import 'package:pcrypt/login/bloc/signup.dart';
...
class _SignUpFormState extends State<SignUpForm> {
  ...
  void _showErrorDialog(String message) {
    showDialog<void>(
        ...
        }).then((_) => _bloc.add(ErrorMessageViewed()));
  }

  void _onUsernameChanged() {
    _bloc.add(EmailChanged(email: _usernameController.text));
  }
  ...
  void _onPasswordVisibilityChanged() {
    _bloc.add(PasswordVisibilityChanged());
  }
