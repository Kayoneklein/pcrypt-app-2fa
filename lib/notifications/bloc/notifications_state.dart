...
class NotificationsState extends Equatable {
  ...
  NotificationsState copyWith({
    ...
    return NotificationsState(
      ...
      isNotificationsAvailable: isNotificationsAvailable ?? this.isNotificationsAvailable,
...
class ConnectionErrorState extends NotificationsState {
  ConnectionErrorState.from(NotificationsState state, {required this.errorMessage})
      : super(
