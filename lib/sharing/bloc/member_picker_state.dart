  ...
  factory MemberPickerState.initial(
    ...
    Iterable<TeamMemberIdPair>? pickedMembers,
      ...
      MemberPickerState(
        ...
        initialSelectedMemberIds: BuiltSet.from(pickedMembers ?? <TeamMemberIdPair>{}),
  ...
  MemberPickerState copyWith({
    ...
    BuiltList<TeamMember>? emailList,
      ...
      MemberPickerState(
        ...
        initialSelectedTeamIds: initialSelectedTeamIds ?? this.initialSelectedTeamIds,
        initialSelectedMemberIds: initialSelectedMemberIds ?? this.initialSelectedMemberIds,
      );
...
class ConnectionErrorState extends MemberPickerState {
  ConnectionErrorState.from(MemberPickerState state, {required this.errorMessage})
      : super(
    currentTab: state.currentTab,
    isLoading: state.isLoading,
    isLoadingError: state.isLoadingError,
