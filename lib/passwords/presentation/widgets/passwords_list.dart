...
import 'package:pcrypt/passwords/presentation/widgets/passwords_list_item.dart';
        ...
        itemBuilder: (context, position) {
          if (_data[position].isShared) {
            return PasswordSharedListItem(
              ...
              onLongPress: () => _onItemLongClicked?.call(position, _data[position]),
              onShareInfo: () => _onShareInfoClicked?.call(position, _data[position]),
