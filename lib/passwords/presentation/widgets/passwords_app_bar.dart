...
import 'package:pcrypt/passwords/bloc/password_edit_bloc.dart';
import 'package:pcrypt/passwords/bloc/password_edit_state.dart';
import 'package:pcrypt/passwords/bloc/passwords.dart';
import 'package:pcrypt/passwords/presentation/widgets/popup_sub_menu_item.dart';
import 'package:pcrypt/util/custom_icons.dart';
import 'package:pcrypt/util/strings.dart';

import '../../bloc/password_edit_event.dart';
...
class _PasswordsAppBarState extends State<PasswordsAppBar> {
  ...
  void initState() {
    ...
    _isSharingAvailable = BlocProvider.of<AuthenticationBloc>(context)
  ...
  Widget _buildFilterButton(BuildContext context, PasswordsState state) {
    if (state.isPasswordsAvailable) {
      ...
      return PopupMenuButton<Filter>(
        icon: Icon((state.currentFilter is AllFilter)
        ...
        state.uploadingFilesCount == 0
            ? IconButton(
                ...
                onPressed: () {
                  ...
                  // _onSubmitPressed();
                  BlocProvider.of<PasswordEditBloc>(context)
                      .add(FormSubmitted());
                },
              )
