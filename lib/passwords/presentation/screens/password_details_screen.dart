...
import 'package:pcrypt/passwords/presentation/screens/file_viewer_screen.dart';
import 'package:pcrypt/passwords/presentation/screens/location_viewer_screen.dart';
import 'package:pcrypt/passwords/presentation/screens/password_edit_screen.dart';
import 'package:pcrypt/util/formatters.dart';
...
class PasswordDetailsState extends State<PasswordDetails> {
  ...
  Future<void> _launchGeo(
      BuildContext context, String title, List<Location> locations) async {
    Navigator.push(
      context,
  ...
  Future<void> _loadLocationNames() async {
    for (int i = 0; i < widget.password.locations.length; i++) {
      try {
        ...
        final address = await LocationService.get
            .getAddressForCoordinates(location.latitude, location.longitude);
            ...
            ? Row(
                children: <Widget>[
                  ...
                  TextButton(
                    ...
                    onPressed: () => _launchGeo(context, widget.password.name,
